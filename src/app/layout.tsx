  ...
  "@graph": [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        {
          "@type": "Question",
          name: "Does AGENTIX AI work with clients outside Slovakia?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. AGENTIX AI is based in Bratislava, Slovakia, and serves clients globally. All collaboration is remote. The founder, Soňa Mášová, has a background in security consulting at Deloitte, IBM, and Takeda, and works in English, Slovak, and Czech.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "MCP (Model Context Protocol) is Anthropic's open standard for connecting AI agents to external tools and data. An MCP server on a website exposes its functionality as callable tools — so an AI agent like Claude can book a meeting, retrieve pricing, or check availability directly, without opening a browser. AGENTIX AI offers full MCP integration as a Layer 03 premium add-on starting at +€2,000.",
          },
        },
        {
          "@type": "Question",
          name: "Who is behind AGENTIX AI?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "AGENTIX AI is run by Soňa Mášová, based in Bratislava, Slovakia. She is a former security consultant with experience at Deloitte, IBM, and Takeda, now building at the intersection of AI, web development, and design. Contact: sona.masova23@gmail.com. Book a call: calendly.com/sona-masova23.",
          },
        },
      ],
    },
