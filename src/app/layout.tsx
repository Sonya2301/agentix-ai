...
const schemaOrg = {
  ...
  "@graph": [
    {
      "@type": "Organization",
      "@id": "https://agentix.ai/#organization",
      name: "AGENTIX AI",
      url: "https://agentix.ai",
      description:
    ...
    {
      "@type": "WebSite",
      "@id": "https://agentix.ai/#website",
      url: "https://agentix.ai",
      name: "AGENTIX AI",
      publisher: { "@id": "https://agentix.ai/#organization" },
    },
    {
      "@type": "Service",
      name: "Three-Layer AI Website Service",
      provider: { "@id": "https://agentix.ai/#organization" },
      description:
