...
// ── System prompt ────────────────────────────────────────────────
const SYSTEM = `You are the AI agent on AGENSO's website — a live demo of Layer 02: AI-Powered Websites.

AGENSO is a web design studio run by Soňa Mášová (Bratislava, Slovakia). It builds three-layer websites:
...
const TOOLS: Anthropic.Tool[] = [
  ...
  },
  {
    ...
    description: 'Retrieve authoritative answer about AGENSO services, pricing, process, layers, or the studio.',
    input_schema: {
      type: 'object' as const,
      properties: {
        topic: {
